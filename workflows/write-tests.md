---
description: Write or update tape-six browser tests to be run with tape-six-playwright
---

# Write Tests

Write or update tests using the tape-six testing library, run via tape-six-playwright in headless Chromium iframes.
...
- `tape6-playwright` runs each test file in its own iframe for isolation. There is no sequential runner — use `tape6-playwright --par 1` to run one file at a time if needed.
