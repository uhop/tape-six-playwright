...
1. Read `bin/tape6-playwright.js`, `bin/tape6-playwright-node.js`, and `src/TestWorker.js` to identify the current CLI options and architecture.
...
7. Update `wiki/Utility-‐-tape6‐playwright.md` if CLI options or cross-runtime usage changed.
